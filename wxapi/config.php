...
// 版本号
define('WXAPI_VERSION', '1.4');
define('WXAPI_VERSION_DATE', '2014-11-05');

/*
 * 服务器配置，详情请参考@link http://mp.weixin.qq.com/wiki/index.php?title=接入指南
 */
define("WECHAT_URL", 'http://rzldboggdq.proxy.qqbrowser.cc/wxapi/interface.php');
define('WECHAT_TOKEN', 'weixin');
define('ENCODING_AES_KEY', "1YQRULkVTGgOSOTYxqLQAGOy5nia5LqaV8D465ZF8J4");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wxee5f674259607538');
define("WECHAT_APPSECRET", '7dc588e636b185912d24d23b14a83099');
